...
Level.create(start: "bear", target: "hare", path: ["bear", "bare", "hare"], limit: 3)
...
#   word_obj = Word.new(word, Dict.new("common"))
#   definition = word_obj.get_definition
#   SavedWord.create(name: word, choices: word_obj.choices([]), definition: definition )
# end
